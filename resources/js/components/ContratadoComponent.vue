   ...
   <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Lista de afiliados Contratados</h4>
...
created: function() {
  ...
  methods: {
       getafiliadoContratado: function() {
          var url = 'http://localhost/DataCreditos/public/lista-contratados';
